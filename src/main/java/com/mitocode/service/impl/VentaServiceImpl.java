...
public class VentaServiceImpl extends CRUDImpl<Venta, Integer> implements IVentaService{
	...
	@Transactional
	@Override
	public Venta registrarTransaccional(Venta venta, List<Producto> productos) throws Exception {
		...
		//productos.forEach(ex -> ceRepo.registrar(consulta.getIdConsulta(), ex.getIdExamen()));
